...
const AdminFightController = require('../../controller/admin/admin.flightController');
...
router.get(
   '/booking-flight',
   AdminLoginController.CheckLogin,
   AdminFightController.GetAllFlight
);
router.get(
   '/booking-flight/:flight_booking_id',
   AdminLoginController.CheckLogin,
...
router.get(
   '/update-ticket',
   AdminLoginController.CheckLogin,
   AdminFightController.UpdateFlightTicket
);
